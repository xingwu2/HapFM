...
option_list = list(
  ...
  make_option(c("-m", "--maf"), type="double", default=NULL, help="maf",metavar="float"),
...
res <- BigLD(geno = geno, SNPinfo = SNPinfo,CLQmode = "density",CLQcut = opt$cut,hrstType="fast",MAFcut=opt$maf)
